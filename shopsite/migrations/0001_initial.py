    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('USER', 'User'), ('PRODUCT', 'Product')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('reported_product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shopsite.product')),
